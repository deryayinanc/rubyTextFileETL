...
file =File.new("CompositeStartDates.csv","r")
...
while (line =file.gets)
	...
	line2 = line.slice(iComma,iStrLen)
	...
	FileUtils.cp fileName, '.\StartModified'
	
	#puts line, fileName, line2, textToSearch, textToReplace 
